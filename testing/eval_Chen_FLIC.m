...
%% load prediction
all = parload('/home/wyang/code/pose/release_pose_evaluation/estimations/flic_oc_estimations_chen_nips14.mat','ests');
...
pred = zeros(2, 10, length(all));
for i = 1:length(all)
  pred(:, :, i) = (Trans_all*all(i).joints)';
end
